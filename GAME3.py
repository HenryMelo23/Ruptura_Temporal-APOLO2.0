    ...
    try:
        ...
        while running:
            ...
            for inimigo in inimigos_comum:
                ...
                inimigo["rect"].x += (dx / dist) * 1.70
                inimigo["rect"].y += (dy / dist) * 1.50 
