...
def tela_de_pausa(velocidade_personagem, intervalo_disparo, vida, largura_disparo, altura_disparo, trembo, dano_person_hit, chance_critico, roubo_de_vida, quantidade_roubo_vida,
    ...
    atributos_cartas = [
        ...
        {"nome": "Cura", "Nick": "Mordida Sombria", 
         "descricao": "Ativa Roubo de Vida. Cada acerto de projetil cura +0.10% da vida perdida de Apolo (a porcentagem de roubo de vida escala em +0.03% a cada 80 abates)."},
    ...
    def aplicar_carta(carta_sel):
        ...
        if nome == "Speed Boost":
            ...
            roubo_de_vida = 1.0
            quantidade_roubo_vida += 0.001 + (inimigos_eliminados // 80) * 0.0003
