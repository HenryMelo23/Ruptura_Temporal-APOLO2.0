...
def tela_de_pausa(velocidade_personagem, intervalo_disparo, vida, largura_disparo, altura_disparo, trembo, dano_person_hit, chance_critico, roubo_de_vida, quantidade_roubo_vida,
    ...
    atributos_cartas = [
        ...
        {"nome": "Cura", "Nick": "Mordida Sombria", 
         "descricao": "Restaure 1% da sua vida a cada hit e 0.5% a cada ativacao. Recupere sua saude enquanto luta!"},
    ...
    def aplicar_carta(carta_sel):
        ...
        if nome == "Speed Boost":
            ...
            roubo_de_vida += 0.01 + (inimigos_eliminados // 80) * 0.005
            quantidade_roubo_vida += 0.005 + (inimigos_eliminados // 80) * 0.002
