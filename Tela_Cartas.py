            ...
            if evento.type == pygame.QUIT:
                ...
                if evento.key == pygame.K_a:  # Tecla A pressionada, seleciona a carta anterior
                    ...
                    if carta_selecionada["nome"] == "Speed Boost":  # Se a carta selecionada for "Speed Boost"
                        ...
                        roubo_de_vida += 0.01 + (inimigos_eliminados // 80) * 0.01  # Aumenta o roubo de vida conforme inimigos eliminados
                        quantidade_roubo_vida += 0.005 + (inimigos_eliminados // 80) * 0.005  # Aumenta a quantidade de roubo de vida
